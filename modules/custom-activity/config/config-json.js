  ...
  return {
    ...
    arguments: {
      execute: {
        ...
        url: `https://${req.headers.host}/modules/custom-activity/execute`,
    ...
    configurationArguments: {
      publish: {
        url: `https://${req.headers.host}/modules/custom-activity/publish`
      },
      validate: {
        url: `https://${req.headers.host}/modules/custom-activity/validate`
      },
      stop: {
        url: `https://${req.headers.host}/modules/custom-activity/stop`
      }
    },
    userInterfaces: {
