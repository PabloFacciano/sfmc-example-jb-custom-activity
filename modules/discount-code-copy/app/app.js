// JOURNEY BUILDER CUSTOM ACTIVITY - discount-code-copy ACTIVITY
// ````````````````````````````````````````````````````````````
...
// setup the discount-code-copy example app
module.exports = function discountCodeExample(app, options) {
    const moduleDirectory = `${options.rootDirectory}/modules/discount-code-copy`;

    // setup static resources
    app.use('/modules/discount-code-copy/dist', express.static(`${moduleDirectory}/dist`));
    app.use('/modules/discount-code-copy/images', express.static(`${moduleDirectory}/images`));

    // setup the index redirect
    app.get('/modules/discount-code-copy/', function(req, res) {
        return res.redirect('/modules/discount-code-copy/index.html');
    });

    // setup index.html route
    app.get('/modules/discount-code-copy/index.html', function(req, res) {
    ...
    app.get('/modules/discount-code-copy/config.json', function(req, res) {
     ...
     */
    app.post('/modules/discount-code-copy/save', function(req, res) {
        console.log('debug: /modules/discount-code-copy/save');
     ...
     * 50x - Return if the configuration is invalid (this will block the publish phase)
     */
    app.post('/modules/discount-code-copy/publish', function(req, res) {
        console.log('debug: /modules/discount-code-copy/publish');
        return res.status(200).json({});
    });
     ...
     * 50x - Return if the configuration is invalid (this will block the publish phase)
     */
    app.post('/modules/discount-code-copy/validate', function(req, res) {
        console.log('debug: /modules/discount-code-copy/validate');
        return res.status(200).json({});
    });
     ...
     * @return {[type]}
     */
    app.post('/modules/discount-code-copy/stop', function(req, res) {
        console.log('debug: /modules/discount-code-copy/stop');
        return res.status(200).json({});
    });
     ...
     */
    app.post('/modules/discount-code-copy/execute', function(req, res) {
        console.log('debug: /modules/discount-code-copy/execute');
