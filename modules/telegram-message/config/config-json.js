  ...
  return {
    ...
    lang: {
      'en-US': {
        ...
        description: 'Send a message using a Telegram Bot.'
      }
    },
    arguments: {
      execute: {
        ...
        url: `https://${req.headers.host}/modules/telegram-message/execute`,
    ...
    configurationArguments: {
      publish: {
        url: `https://${req.headers.host}/modules/telegram-message/publish`
      },
      validate: {
        url: `https://${req.headers.host}/modules/telegram-message/validate`
      },
      stop: {
        url: `https://${req.headers.host}/modules/telegram-message/stop`
      }
    },
    userInterfaces: {
